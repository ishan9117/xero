<?php
  ...
  $xeroTenantId = $storage->getSession()['tenant_id'];
  ...
  if (isset($_GET['action'])) {
    if ($_GET["action"] == 1) {
        ...
        try {
            ...
            $contact->setName('FodddddddddddddddoBar')
                ->setFirstName("Foo")
                ->setLastName("Bar")
...
<html>
    <body>
        <ul>
            <li><a href="xero_authorizedResource.php?action=1">Get Organisation Name</a></li>
            <li><a href="xero_authorizedResource.php?action=2">Create one Contact</a></li>
            <li><a href="xero_authorizedResource.php?action=3">Get Invoice with Filters</a></li>
            <li><a href="xero_authorizedResource.php?action=4">Create multiple contacts and summarizeErrors</a></li>
        </ul>
        <div>
        <?php
            echo($message );
